...
apk_sources = {
    ...
    "pixiv": {APK_PURE_BASE_APK_URL}"/jp.pxv.android?version=latest",
    "reddit": {APK_PURE_BASE_APK_URL}"/com.reddit.frontpage?version=latest",
    ...
    "windy": {APK_PURE_BASE_APK_URL}"/co.windyapp.android?version=latest",
